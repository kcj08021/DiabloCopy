...
HRESULT CHeavyArmor::Release(){
	return S_OK;
}

HRESULT CHeavyArmor::Initialize(){
	m_tInfo.vSize = { 2.f, 2.f, 0.f };
	m_tInfo.vPos = { 0.f, 0.f, 0.f };
	m_tInfo.vDir = { 0.f, 1.f, 0.f };

	m_wstrTypeKey = L"Item";
	m_wstrObjectKey = L"HeavyArmor";
...
HRESULT CHeavyArmor::LateInit(){
	m_tStat.iArmor = m_iIndex + 1;
	return S_OK;
}

HRESULT CHeavyArmor::Update(){
	if(!m_bIsInit){
...
HRESULT CHeavyArmor::LateUpdate(){
	return S_OK;
}

HRESULT CHeavyArmor::Render(){
...
CHeavyArmor * CHeavyArmor::Create(const D3DXVECTOR3 & _vPos/* = D3DXVECTOR3{}*/){
	CHeavyArmor* pInstance = new CHeavyArmor;
