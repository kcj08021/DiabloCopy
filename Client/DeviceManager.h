...
private:
	...
	LPD3DXLINE			m_pLine;		//ID3DXLine의 포인터

	LPD3DXFONT			m_pFont;		//iD3DXFont의 포인터
	LPD3DXFONT			m_pDibloSmallFont;	
	LPD3DXFONT			m_pDibloBigFont;
...
public:
	...
	LPD3DXFONT GetSmallFont(){ return m_pDibloSmallFont; }
	LPD3DXFONT GetBigFont(){ return m_pDibloBigFont; }
